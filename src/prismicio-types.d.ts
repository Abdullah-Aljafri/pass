...
export interface SettingDocumentDataNavigationItem {
	 ...
	 * - **Placeholder**: *None*
	 * - **Default Value**: false
	 * - **API ID Path**: setting.navigation[].cta_button
...
interface SettingDocumentData {
	/**
	 * Site Titel field in *Settings*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: setting.site_titel
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/field#key-text
	 */
	site_titel: prismic.KeyTextField;
...
export type AllDocumentTypes = CaseStudyDocument | PageDocument | SettingDocument;
...
export interface IntegrationSliceDefaultPrimaryRepeatableZoneItem {
	 ...
	 */
	icon: prismic.SelectField<'cloudflare' | 'npm' | 'figma' | 'digitalocean ' | 'fly'>;
}
...
export interface IntegrationSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	repeatable_zone: prismic.GroupField<Simplify<IntegrationSliceDefaultPrimaryRepeatableZoneItem>>;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type IntegrationSlice = prismic.SharedSlice<'integration', IntegrationSliceVariation>;
